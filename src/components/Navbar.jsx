...
<div className="mt-5  hidden md:block">
  <ul className="font-semibold flex gap-10  justify-center overflow-visible h-10">
    <li className="flex flex-col items-end group whitespace-nowrap ">
      ...
      <ul className="mt-3   p-2 hidden rounded-lg space-y-3 cursor-pointer bg-white group-hover:block absolute shadow-2xl  top-20 2xl:top-[48px]">
    ...
    <li className="flex flex-col items-end group whitespace-nowrap  ">
      ...
      <ul className="mt-3 p-2 hidden rounded-lg space-y-3 cursor-pointer bg-white group-hover:block absolute transition duration-200 ease-in-out shadow-2xl  top-20 2xl:top-[48px]">
